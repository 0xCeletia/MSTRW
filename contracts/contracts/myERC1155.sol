...
contract MyERC1155 is IERC1155MetadataURI, Ownable, modifiedERC1155('uri_/https://game.example/api/item/{id}.json') {
  ...
  modifier ownersOnly(uint256 _id) {
    require(_balances[_id][msg.sender] > 0, "ERC1155#ownersOnly: ONLY_OWNERS_ALLOWED");
    _;
  }
  ...
  function setCreator(
    ...
    require(creators[_ids] == msg.sender, "ERC1155Tradable#batchMint: ONLY_CREATOR_ALLOWED");
    ...
    function __burn(address from, uint256 id, uint256 amount) internal {
        ...
        (uint256[] memory ids, uint256[] memory amounts) = __asSingletonArrays(id, amount);
     ...
     */
    function __safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes memory data) public virtual {
