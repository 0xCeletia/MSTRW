...
type ButtonColor = "primary" | "openblue" | "bluee" | "danger";
...
export const useButtonClassName = (
    ...
    const colorAndSizeClassNames = useMemo((): string => {
        ...
        } else if (color === "openblue") {
            arr = [
                "bg-buttonopenblueBg",
                "hover:bg-buttonopenblueBgHover",
                "text-buttonopenblueColor",
                "hover:text-buttonopenblueColorHover",
            ];
        } else if (color === "bluee") {
            arr = [
                "bg-buttonBlueeBg",
                "hover:bg-buttonBlueeBgHover",
                "text-buttonBlueeColor",
                "hover:text-buttonBlueeColorHover",
            ];
